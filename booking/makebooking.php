...
<table border="1" cellpadding="5" width="800">
	<tr>
		<td valign="top">
		<form action="book.php" method="post" style="padding: 10px;">
			<h3 style="font-family: 'Pacifico', cursive; color: black;">Make booking</h3>
			<p><input checked = "checked" name="item" type="radio" value="Andy" />Andy
			| <input name="item" type="radio" value="Pete" />Pete
			| <input name="item" type="radio" value="Mary" />Mary | 
			<input name="item" type="radio" value="Joe" />Joe</p>
		...
		<form action="delete.php" method="post" style="padding: 10px;">
		<h3 style="font-family: 'Pacifico', cursive; color: black;">Cancel booking</h3>
			<p></p>
